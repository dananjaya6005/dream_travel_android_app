...
public class RegisterActivity extends AppCompatActivity {
    ...
    public static boolean isValidPassword(EditText passwordField) {
    ...
    public void CheckFinalResult(){
        ...
        if(F_Result.equalsIgnoreCase("Email Found"))
        {
            ...
            if (isValidEmail(emailField) && isValidPassword(passwordField)) {
                // Valid email address
                InsertDataIntoSQLiteDatabase(); // If email already dose n't exists then user registration details will entered to SQLite database.
            } else {

                    if(isValidEmail(emailField) == false){
                        Toast.makeText(RegisterActivity.this,"Invalid Email",Toast.LENGTH_LONG).show();

                    } else if (isValidPassword(passwordField) == false) {
